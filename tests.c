...
bool testCalcDayOfWeek(void)
{
	...
	bool ok5 = false;
	//Random year test
	if(calculate_day_of_week(19,8,2052)==4)//, this is Sept
	{
			//good
			ok5 = true;
	}
	bool ok6 = false;
	//Random year test
	if(calculate_day_of_week(26,6,2134)==1)//, this is July
	{
			//good
			ok6 = true;
	}
	bool ok7 = false;
	//test in 3000
		if(calculate_day_of_week(1,0,3000)==3)//, this is Jan
		{
			//good
			ok7 = true;
		}
	bool ok8 = false;
	//Invalid year
	if(calculate_day_of_week(1,1,1751)==-1)//, year is below 1752
	{
				//good
				ok8 = true;
	...
	bool ok9 = false;
	//Invalid month
	if(calculate_day_of_week(1,12,2020)==-1)//, month is greater than 11
	{
					//good
					ok9 = true;
	...
	bool ok10 = false;
	//Invalid day
	if(calculate_day_of_week(0,1,2020)==-1)//, day is less than 1
	{
					//good
					ok10 = true;
